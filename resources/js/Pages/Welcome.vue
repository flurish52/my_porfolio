<template>
    <div class="min-h-screen bg-surface font-sans text-primary">
        ...
        >
            ...
            <span class="block font-serif italic font-normal text-[0.45em] text-primary/45 mb-1 tracking-normal">
              ...
              />
                    ...
                    <div class="flex flex-wrap gap-3 mb-10">
                     ...
                     bg-primary text-surface text-sm font-semibold tracking-wide
            ...
            <span
                ...
                class="font-mono text-[0.65rem] tracking-wide px-2.5 py-1 rounded
                     border border-primary/15 text-primary/50
                     hover:border-primary/40 hover:text-primary/80
            ...
            <span class="font-display font-black text-[2.2rem] leading-none tracking-tight text-primary">
              {{ stat.value }}
                        ...
                        <span class="font-mono text-[0.58rem] tracking-[0.14em] uppercase text-primary/35">
              {{ stat.label }}
            </span>
                    </div>
                </div>
            ...
            <section
                id="contact"
                class="min-h-screen px-8 md:px-16 py-20 bg-primary"
            >
                ...
                >
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="flex flex-col gap-1.5">
                            <label class="font-mono text-[0.58rem] tracking-[0.14em] uppercase text-surface/40" for="cf-name">Name</label>
                            <input
                                id="cf-name"
                                v-model="form.name"
                                type="text"
                       ...
                       transition-colors duration-200"
                        ...
                        <div class="flex flex-col gap-1.5">
                            <label class="font-mono text-[0.58rem] tracking-[0.14em] uppercase text-surface/40" for="cf-email">Email</label>
                            <input
                                id="cf-email"
                                v-model="form.email"
                                type="email"
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label class="font-mono text-[0.58rem] tracking-[0.14em] uppercase text-surface/40" for="cf-message">Message</label>
                        <textarea
                            id="cf-message"
                   ...
                   bg-surface text-primary text-sm font-bold tracking-wide
...
//     // Wire to your Laravel route here
...
.animate-expand-x { animation: expand-x 0.6s ease 0.3s both; }
</style>
